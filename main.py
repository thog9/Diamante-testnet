...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Faucet $DIAM", "value": "faucet", "locked": True},
            {"name": "2. Gửi TX ngẫu nhiên hoặc File (address.txt)", "value": "transfer", "locked": True},

            {"name": "X. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Faucet $DIAM", "value": "faucet", "locked": True},
            {"name": "2. Send TX random or File (address.txt)", "value": "transfer", "locked": True},
            {"name": "X. Thoát", "value": "exit"},
        ]
    }
